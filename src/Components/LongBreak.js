...
function LongBreak() {
    ...
    return (
        ...
        <div className='p-4 text-center mt-5  me-5 ms-5 bg-secondary bg-gradient bg-opacity-10 shadow'>
            <h5 className='bg-secondary bg-gradient p-4 text-white'>Long Break</h5>
            <div className=" bg-secondary bg-gradient bg-opacity-75 p-4">
           ...
           <button className='btn mt-3  bg-secondary bg-gradient bg-opacity-50 text-white '  onClick={startTimer}>Start</button>
        </div>
        </div>
    )
}
